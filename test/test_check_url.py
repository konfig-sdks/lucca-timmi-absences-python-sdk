...
import unittest
from lucca_timmi_absences_python_sdk.configuration import check_url
from lucca_timmi_absences_python_sdk.exceptions import InvalidHostConfigurationError
