...
from lucca_timmi_absences_python_sdk.model.imports_replace_entitlements_request1 import ImportsReplaceEntitlementsRequest1 as ImportsReplaceEntitlementsRequest1Schema
...
from lucca_timmi_absences_python_sdk.type.imports_replace_entitlements_request1 import ImportsReplaceEntitlementsRequest1

from ...api_client import Dictionary
from lucca_timmi_absences_python_sdk.pydantic.imports_replace_entitlements_request1 import ImportsReplaceEntitlementsRequest1 as ImportsReplaceEntitlementsRequest1Pydantic
...
# body param
SchemaForRequestBodyMultipartFormData = ImportsReplaceEntitlementsRequest1Schema


request_body_imports_replace_entitlements_request1 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _replace_entitlements_0_mapped_args(
        self,
    ...
    async def _areplace_entitlements_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timmi-absences/api/public/services/v1.0/leaveEntitlementsReplace',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_imports_replace_entitlements_request1.serialize(body, content_type)
    ...
    def _replace_entitlements_0_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ReplaceEntitlements0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_entitlements_0(
        self,
        strict: typing.Optional[bool] = None,
        simulate: typing.Optional[bool] = None,
        file: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._replace_entitlements_0_mapped_args(
            strict=strict,
            simulate=simulate,
            file=file,
        ...
        return await self._areplace_entitlements_0_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def replace_entitlements_0(
        self,
        strict: typing.Optional[bool] = None,
        simulate: typing.Optional[bool] = None,
        file: typing.Optional[str] = None,
        ...
        return self._replace_entitlements_0_oapg(
            body=args.body,
            query_params=args.query,
        )

class ReplaceEntitlements0(BaseApi):
    ...
    async def areplace_entitlements_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areplace_entitlements_0(
            strict=strict,
            simulate=simulate,
            file=file,
            description=description,
    ...
    def replace_entitlements_0(
        ...
        raw_response = self.raw.replace_entitlements_0(
            strict=strict,
            simulate=simulate,
            file=file,
            description=description,
