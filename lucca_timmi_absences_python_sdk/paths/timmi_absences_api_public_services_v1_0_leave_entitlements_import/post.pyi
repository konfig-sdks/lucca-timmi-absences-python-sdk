...
from lucca_timmi_absences_python_sdk.model.imports_import_leave_entitlements_request import ImportsImportLeaveEntitlementsRequest as ImportsImportLeaveEntitlementsRequestSchema

from lucca_timmi_absences_python_sdk.type.imports_import_leave_entitlements_request import ImportsImportLeaveEntitlementsRequest
...
from lucca_timmi_absences_python_sdk.pydantic.imports_import_leave_entitlements_request import ImportsImportLeaveEntitlementsRequest as ImportsImportLeaveEntitlementsRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = ImportsImportLeaveEntitlementsRequestSchema


request_body_imports_import_leave_entitlements_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _import_leave_entitlements_mapped_args(
        self,
    ...
    async def _aimport_leave_entitlements_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/timmi-absences/api/public/services/v1.0/leaveEntitlementsImport',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_imports_import_leave_entitlements_request.serialize(body, content_type)
    ...
    def _import_leave_entitlements_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ImportLeaveEntitlementsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aimport_leave_entitlements(
        self,
        strict: typing.Optional[bool] = None,
        simulate: typing.Optional[bool] = None,
        file: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._import_leave_entitlements_mapped_args(
            strict=strict,
            simulate=simulate,
            file=file,
        ...
        return await self._aimport_leave_entitlements_oapg(
            body=args.body,
            query_params=args.query,
            **kwargs,
        )
    
    def import_leave_entitlements(
        self,
        strict: typing.Optional[bool] = None,
        simulate: typing.Optional[bool] = None,
        file: typing.Optional[str] = None,
        ...
        return self._import_leave_entitlements_oapg(
            body=args.body,
            query_params=args.query,
        )

class ImportLeaveEntitlements(BaseApi):
    ...
    async def aimport_leave_entitlements(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aimport_leave_entitlements(
            strict=strict,
            simulate=simulate,
            file=file,
            description=description,
    ...
    def import_leave_entitlements(
        ...
        raw_response = self.raw.import_leave_entitlements(
            strict=strict,
            simulate=simulate,
            file=file,
            description=description,
