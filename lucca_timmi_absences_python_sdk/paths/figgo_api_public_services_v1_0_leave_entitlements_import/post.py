...
from lucca_timmi_absences_python_sdk.model.imports_entitlements_batch_import_request import ImportsEntitlementsBatchImportRequest as ImportsEntitlementsBatchImportRequestSchema
...
from lucca_timmi_absences_python_sdk.type.imports_entitlements_batch_import_request import ImportsEntitlementsBatchImportRequest

from ...api_client import Dictionary
from lucca_timmi_absences_python_sdk.pydantic.imports_entitlements_batch_import_request import ImportsEntitlementsBatchImportRequest as ImportsEntitlementsBatchImportRequestPydantic
...
# body param
SchemaForRequestBodyMultipartFormData = ImportsEntitlementsBatchImportRequestSchema


request_body_imports_entitlements_batch_import_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _entitlements_batch_import_mapped_args(
        self,
    ...
    async def _aentitlements_batch_import_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/figgo/api/public/services/v1.0/leaveEntitlementsImport',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_imports_entitlements_batch_import_request.serialize(body, content_type)
    ...
    def _entitlements_batch_import_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EntitlementsBatchImportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="imports")
    async def aentitlements_batch_import(
        self,
        strict: typing.Optional[bool] = None,
        simulate: typing.Optional[bool] = None,
        file: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._entitlements_batch_import_mapped_args(
            strict=strict,
            simulate=simulate,
            file=file,
        ...
        return await self._aentitlements_batch_import_oapg(
            body=args.body,
    ...
    def entitlements_batch_import(
        ...
        return self._entitlements_batch_import_oapg(
            body=args.body,
            query_params=args.query,
        )

class EntitlementsBatchImport(BaseApi):
    ...
    async def aentitlements_batch_import(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aentitlements_batch_import(
            strict=strict,
            simulate=simulate,
            file=file,
            description=description,
    ...
    def entitlements_batch_import(
        ...
        raw_response = self.raw.entitlements_batch_import(
            strict=strict,
            simulate=simulate,
            file=file,
            description=description,
