...
class RequiredImportsReplaceEntitlementsRequest1(TypedDict):
    pass

class OptionalImportsReplaceEntitlementsRequest1(TypedDict, total=False):
    File: str
...
class ImportsReplaceEntitlementsRequest1(RequiredImportsReplaceEntitlementsRequest1, OptionalImportsReplaceEntitlementsRequest1):
    pass
