...
class RequiredImportsReplaceEntitlementsRequest(TypedDict):
    pass

class OptionalImportsReplaceEntitlementsRequest(TypedDict, total=False):
    File: str
...
class ImportsReplaceEntitlementsRequest(RequiredImportsReplaceEntitlementsRequest, OptionalImportsReplaceEntitlementsRequest):
    pass
